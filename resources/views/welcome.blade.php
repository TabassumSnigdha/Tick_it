...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <a href="{{ url('/brand') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Home</a>
            @else
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="100%" viewBox="0 0 1950 850" preserveAspectRatio="xMinYMin meet">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <!-- <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target=”_blank” class="underline text-gray-900 dark:text-white">Tick-IT</a></div>
                        </div> -->

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Tick-It has wonderful, thorough documentation covering every aspect of the website. Whether you are new to the buying tickets online or have previous experience with trickit, we recommend reading all of the documentation from beginning to end.
                            </div>
                        </div>
                    </div>
